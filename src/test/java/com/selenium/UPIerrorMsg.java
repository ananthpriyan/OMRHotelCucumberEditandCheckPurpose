...
public class UPIerrorMsg {
		...
		WebDriver driver;
		  ...
		  driver.findElement(By.xpath("//p[text()='Pay Directly From Your Bank Account']")).click();
		  
		  driver.findElement(By.id("upi_id")).sendKeys("ananth@gmail.com");
		  
		  driver.findElement(By.id("submitBtn")).click();
		  String text2 = driver.findElement(By.xpath("//div[text()='Invalid UPI ID']")).getText();
