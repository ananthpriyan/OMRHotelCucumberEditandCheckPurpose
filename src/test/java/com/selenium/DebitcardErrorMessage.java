...
public class DebitcardErrorMessage {
...
WebDriver driver;
  ...
  driver.findElement(By.id("card_no")).sendKeys("5465555534352222");
  ...
  String text = driver.findElement(By.id("invalid-card_no")).getText();
